...
with tab4:
    ...
    with tool_tab2:
        ...
        **📊 학생별 설정**:
        - 양서준: 원가 7,000원 → 추천 판매가 70,000~90,000원
        - 이영미: 원가 5,000원 → 추천 판매가 50,000~70,000원
        - 양성민: 원가 3,000원 → 추천 판매가 30,000~50,000원
        - 박재욱/김태성 (팀): 원가 20,000원 → 추천 판매가 40,000~60,000원
        - 김범규: 원가 1,000원, **대출금 800,000원** (이자 10%) → 추천 판매가 10,000~20,000원
        - 이소민: 원가 1,000원, **대출금 1,000,000원** (이자 10%) → 추천 판매가 10,000~20,000원
        - 전찬연: 다중상품
          - 오므라이스 2,000원 → 20,000~30,000원
          - 메론소다 1,000원 → 10,000~20,000원
          - 레인보우샤베트 1,000원 → 10,000~20,000원
          - 찬연이의 애교 서비스(가성비) 0원 → 10,000~20,000원
          - 찬연이의 애교 서비스(프리미엄) 0원 → 30,000~50,000원
        
        **👥 구매자 예산 분포** (18명):
        - 💎 큰손 (6명): 1,000,000~2,000,000원
        - 😊 일반 (6명): 400,000~700,000원
        - 🤏 짠물 (6명): 150,000~300,000원
        """)
